...
export class GooglePlusService {
  ...
  getAccessTokenFromServerAuthCode(serverAuthCode):Observable<any>{
    let headers = new Headers({'Content-Type': 'application/x-www-form-urlencoded'});
      let data =
      'client_id=com.googleusercontent.apps.6996723272-kiv5cpplhama4ie93ubi0vdfmpmr43lo&client_secret=H9rDyxNEJzZaT8o6J-dNbFXd&grant_type=authorization_code&code='+serverAuthCode
